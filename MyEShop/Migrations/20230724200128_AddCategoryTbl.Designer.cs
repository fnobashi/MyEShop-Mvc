...
namespace MyEShop.Migrations
{
    ...
    [Migration("20230724200128_AddCategoryTbl")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyEShop.Models.Entities.Users.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 7, 24, 23, 31, 28, 448, DateTimeKind.Local).AddTicks(8018),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 7, 24, 23, 31, 28, 448, DateTimeKind.Local).AddTicks(8088),
                            IsDeleted = false,
                            RoleName = "Operator"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 7, 24, 23, 31, 28, 448, DateTimeKind.Local).AddTicks(8110),
                            IsDeleted = false,
                            RoleName = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("MyEShop.Models.Entities.Category.Category", b =>
                {
                    b.HasOne("MyEShop.Models.Entities.Category.Category", "Children")
                        .WithMany()
